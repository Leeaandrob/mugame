...
[![Deploy to Cloudflare](https://deploy.workers.cloudflare.com/button)](https://deploy.workers.cloudflare.com/?url=https://github.com/cloudflare/templates/tree/main/mugame-worker)
...
```
npm create cloudflare@latest -- --template=cloudflare/templates/mugame-worker
```

A live public deployment of this template is available at [https://mugame-worker.templates.workers.dev](https://mugame-worker.templates.workers.dev)
